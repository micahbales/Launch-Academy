...
feature "user views post description via link from index" do
  ...
  let!(:post2) { Post.create(title: "How does this eRuby thing work, anyway?", description: "Maecenas congue molestie velit in egestas. Donec gravida ex quis odio placerat placerat. Pellentesque a velit accumsan, cursus urna in, fermentum sem.") }
