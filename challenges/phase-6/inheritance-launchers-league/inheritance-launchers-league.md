...
ADDITIONAL CHALLENGE: Refactor the above example to use Modules instead of Inheritance! Compare the resulting code with your results when you used inheritance. 
